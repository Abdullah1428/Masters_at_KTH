...
species Auctioneer skills: [fipa] {
	...
	reflex startAuction when: auctionPhase = 0 and flip(auctionStart) {
		...
		write name + ' started dutch auction with starting price of ' + startingPrice + ' and genre ' + auctionGenre;
...
species Participant skills: [fipa, moving] {
	...
	string participantGenre <- any(genres);
...
experiment AuctionChallenge1 type: gui {
	output {
